...
<div class="wp-block-group" style="border-top-color:#cccccc;border-top-width:1px;margin-top:0;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)"><!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
    <div class="wp-block-group alignwide"><!-- wp:group {"align":"full","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
        <div class="wp-block-group alignfull"><!-- wp:columns -->
            ...
            <div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|40"}}}} -->
                <div class="wp-block-columns"><!-- wp:column -->
                    <div class="wp-block-column"><!-- wp:group {"className":"mobile-justify-center","style":{"layout":{"selfStretch":"fill","flexSize":null}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left"}} -->
                    ...
                    <!-- wp:column -->
                    <div class="wp-block-column"><!-- wp:group {"className":"mobile-full-width mobile-justify-center","fontSize":"regular","layout":{"type":"flex","orientation":"vertical","verticalAlignment":"top","justifyContent":"left"}} -->
                        <div class="wp-block-group mobile-full-width has-regular-font-size"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast"} -->
                            <p class="has-contrast-color has-text-color has-link-color text-uppercase font-medium"> İletişim</p>
                            <!-- /wp:paragraph -->
                    ...
                    <div class="wp-block-column"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical"}} -->
                        <div class="wp-block-group"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast"} -->
                            <p class="has-contrast-color has-text-color has-link-color text-uppercase font-medium">Kültürel</p>
                            <!-- /wp:paragraph -->
                    ...
                    <div class="wp-block-column"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical"}} -->
                        <div class="wp-block-group"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast"} -->
                            <p class="has-contrast-color has-text-color has-link-color text-uppercase font-medium">Kurumsal</p>
                            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group mobile-justify-center">
            ...
            <ul class="wp-block-social-links is-style-logos-only">
                ...
                <!-- wp:social-link {"url":"https://www.instagram.com/hkunv/?hl=tr","service":"instagram"} /-->
                ...
                <!-- wp:social-link {"url":"https://tr.linkedin.com/school/hkunv/","service":"linkedin"} /-->
            </ul>
            <!-- /wp:social-links -->
